...
var SchemaInferenceEngine = class {
  ...
  isEntity(obj) {
    ...
    const hasId = obj.id !== void 0 || obj._id !== void 0;
    const fieldCount = Object.keys(obj).length;
    const hasMultipleFields = fieldCount >= 2;
    const hasEntityFields = obj.name !== void 0 || obj.title !== void 0 || obj.description !== void 0 || obj.type !== void 0;
...
// .wrangler/tmp/bundle-TnPnnL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TnPnnL/middleware-loader.entry.ts
